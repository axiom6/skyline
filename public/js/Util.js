...
Util = (function() {
  ...
  Util.xyScale = function(prev, next, port, land) {
    var xn, xp, xs, yn, yp, ys, _ref, _ref1;
    _ref = prev.orientation === 'Portrait' ? [port[2], port[3]] : [land[2], land[3]], xp = _ref[0], yp = _ref[1];
    _ref1 = next.orientation === 'Portrait' ? [port[2], port[3]] : [land[2], land[3]], xn = _ref1[0], yn = _ref1[1];
  ...
  */
  ...
  Util.parseURI = function(uri) {
    var a, name, nameValue, nameValues, parse, value, _i, _len, _ref;
    parse = {};
    parse.params = {};
    ...
    if (Util.isArray(nameValues)) {
      for (_i = 0, _len = nameValues.length; _i < _len; _i++) {
        nameValue = nameValues[_i];
        _ref = nameValue.split('='), name = _ref[0], value = _ref[1];
  ...
  Util.toArray = function(objects, whereIn, keyField) {
    var array, key, object, where, _i, _len;
    if (whereIn == null) {
      whereIn = null;
    }
    if (keyField == null) {
  ...
  Util.toObjects = function(rows, whereIn, key) {
    var ckey, objects, row, where, _i, _len;
    if (whereIn == null) {
      whereIn = null;
    }
    if (key == null) {
    ...
    if (Util.isArray(rows)) {
      ...
      for (key in rows) {
        if (!__hasProp.call(rows, key)) continue;
        row = rows[key];
        if (where(row)) {
          objects[key] = row;
        }
  ...
  Util.toKeys = function(rows, whereIn, keyProp) {
    var key, keys, row, where, _i, _len;
    if (whereIn == null) {
      whereIn = null;
    }
    if (keyProp == null) {
