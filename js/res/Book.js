...
(function() {
  ...
  Book = (function() {
    ...
    Book.prototype.initsHtml = function() {
      var htm;
      htm = "<label class=\"init-font\">&nbsp;&nbsp;Arrive:" + (this.htmlSelect("Months", Data.months, this.month, 'months')) + "</label>";
      htm += "<label class=\"init-font\">&nbsp;&nbsp;       " + (this.htmlSelect("Days", Data.days, this.begDay, 'days')) + "</label>";
    ...
    Book.prototype.g = function(roomId) {
      return this.htmlSelect(roomId + 'G', Data.persons, 2, 'guests', this.rooms[roomId].max);
    };

    Book.prototype.p = function(roomId) {
      return this.htmlSelect(roomId + 'P', Data.pets, 0, 'pets', 3);
    };
